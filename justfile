...
static-type-check-python:
    ...
    uv run poe static-type-check-python --package=data-processing.nats.audio-stream-publisher
    ...
    uv run poe static-type-check-python --package=llm-post-training.fine-tuning.hm-swift
