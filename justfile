...
static-type-check-python:
    ...
    uv run poe static-type-check-python --package=boosting.hm-catboost
    uv run poe static-type-check-python --package=boosting.hm-lightgbm
    uv run poe static-type-check-python --package=boosting.hm-xgboost
    ...
    uv run poe static-type-check-python --package=large-language-model-inference.analyze-sentiment
    uv run poe static-type-check-python --package=large-language-model-inference.hm-mlx-lm
    uv run poe static-type-check-python --package=large-language-model-inference.hm-sglang
