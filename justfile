...
static-type-check-python:
    ...
    uv run poe static-type-check-python --package=fine-tuning.hm-torchtune
    uv run poe static-type-check-python --package=fine-tuning.hm-unsloth
    ...
    uv run poe static-type-check-python --package=llm-inference.post-training-quantization
