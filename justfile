...
static-type-check-python:
    ...
    uv run poe static-type-check-python --package=audio.voice-activity-detector.rnnoise-vad
    uv run poe static-type-check-python --package=audio.voice-activity-detector.webrtc-vad
