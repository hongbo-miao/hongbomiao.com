# https://github.com/NVIDIA/modulus/blob/main/examples/cfd/ldc_pinns/README.md
...
def ldc_trainer(cfg: DictConfig) -> None:
    ...
    scheduler = lr_scheduler.LambdaLR(
        optimizer,
        lr_lambda=lambda step: 0.9999871767586216**step,
    )
    ...
    for i in range(10000):
        ...
        if i % 1000 == 0:
            with torch.no_grad():
                ...
                plt.savefig(f"./output/output_pc_{i}.png")
                plt.close()
