...
def main() -> None:
    ...
    # args
    pdf_file_name = "/Users/hongbo-miao/Downloads/System Identification Resources for Hongbo-1/CIFER User's Guide v8.0 copy.pdf"  # replace with the real pdf path
