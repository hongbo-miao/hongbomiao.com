...
pub async fn publish_transcription(
    ...
    audio_metadata: &AudioMetadata<'_>,
) -> Result<()> {
    let transcription_bytes = {
        let mut message = capnp::message::Builder::new_default();
        {
            ...
            transcription.set_sample_rate_hz(audio_metadata.sample_rate_hz);
            transcription.set_audio_data(audio_metadata.audio_data);
            transcription.set_audio_format(audio_metadata.audio_format);
