...
require (
	...
	go.elastic.co/apm/module/apmgin/v2 v2.4.6
	go.elastic.co/apm/module/apmgrpc/v2 v2.4.6
...
require (
	...
	google.golang.org/grpc/examples v0.0.0-20230831183909-e498bbc9bd37 // indirect
