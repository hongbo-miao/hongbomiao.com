...
def main() -> None:
    ...
    logger.info(f"Groupby operations time: {groupby_time:.2f} seconds")

    # Print total execution time
    logger.info(
        f"Total execution time: {load_time + sum_time + groupby_time:.2f} seconds",
    )
