terraform {
  backend "s3" {
    ...
    key    = "production/snowflake/terraform.tfstate"
  }
  required_providers {
...
provider "snowflake" {
  ...
  role  = "HM_PRODUCTION_TERRAFORM_READ_WRITE_ROLE"
}
...
module "snowflake_transfer_production_department_database_ownership_to_sysadmin_role" {
  providers               = { snowflake = snowflake.hm_production_terraform_read_write_role }
...
module "snowflake_transfer_production_department_db_schema_ownership_to_sysadmin_role" {
  providers               = { snowflake = snowflake.hm_production_terraform_read_write_role }
...
module "snowflake_production_hongbomiao_streamlit_db_department_read_write_role" {
  ...
  source              = "../../../modules/snowflake/hm_snowflake_role"
  for_each            = local.department_names
  snowflake_role_name = "HM_${module.snowflake_production_hongbomiao_streamlit_db_database.name}_${each.value}_READ_WRITE_ROLE"
}
module "snowflake_grant_database_privileges_to_production_hongbomiao_streamlit_db_read_write_role" {
  providers               = { snowflake = snowflake.hm_production_terraform_read_write_role }
  source                  = "../../../modules/snowflake/hm_snowflake_grant_database_privileges_to_role"
  for_each                = { for x in local.department_name_schema_name_list : "${x.department_name}.${x.schema_name}" => x }
  snowflake_role_name     = "HM_${module.snowflake_production_hongbomiao_streamlit_db_database.name}_${each.value.department_name}_READ_WRITE_ROLE"
  privileges              = ["USAGE"]
  snowflake_database_name = module.snowflake_production_hongbomiao_streamlit_db_database.name
  depends_on = [
    module.snowflake_production_hongbomiao_streamlit_db_department_read_write_role,
...
module "snowflake_production_hm_kafka_db_product_schema" {
  providers               = { snowflake = snowflake.hm_production_terraform_read_write_role }
  source                  = "../../../modules/snowflake/hm_snowflake_schema"
...
module "snowflake_production_hm_kafka_db_product_read_write_role" {
  providers           = { snowflake = snowflake.hm_production_terraform_read_write_role }
  source              = "../../../modules/snowflake/hm_snowflake_role"
  snowflake_role_name = "HM_${module.snowflake_production_hm_kafka_db_database.name}_${module.snowflake_production_hm_kafka_db_product_schema.name}_READ_WRITE_ROLE"
}
module "snowflake_production_hm_kafka_db_product_read_write_user" {
  providers                                 = { snowflake = snowflake.hm_production_terraform_read_write_role }
  source                                    = "../../../modules/snowflake/hm_snowflake_user"
  snowflake_user_name                       = "HM_${module.snowflake_production_hm_kafka_db_database.name}_${module.snowflake_production_hm_kafka_db_product_schema.name}_READ_WRITE_USER"
  default_role                              = module.snowflake_production_hm_kafka_db_product_read_write_role.name
  rsa_public_key_without_header_and_trailer = var.production_hm_kafka_db_product_read_write_user_rsa_public_key_without_header_and_trailer
  depends_on = [
    module.snowflake_production_hm_kafka_db_product_read_write_role
  ]
}
module "snowflake_grant_production_hm_kafka_db_product_read_write_role_to_production_hm_kafka_db_product_read_write_user" {
  providers           = { snowflake = snowflake.hm_production_terraform_read_write_role }
  source              = "../../../modules/snowflake/hm_snowflake_grant_role_to_user"
  snowflake_role_name = module.snowflake_production_hm_kafka_db_product_read_write_role.name
  snowflake_user_name = module.snowflake_production_hm_kafka_db_product_read_write_user.name
  depends_on = [
    module.snowflake_production_hm_kafka_db_product_read_write_user,
    module.snowflake_production_hm_kafka_db_product_read_write_role
  ]
...
module "snowflake_grant_database_privileges_to_production_hm_kafka_db_product_read_write_role" {
  providers               = { snowflake = snowflake.hm_production_terraform_read_write_role }
  source                  = "../../../modules/snowflake/hm_snowflake_grant_database_privileges_to_role"
  snowflake_role_name     = module.snowflake_production_hm_kafka_db_product_read_write_role.name
  privileges              = ["USAGE"]
...
module "snowflake_grant_schema_privileges_to_production_hm_kafka_db_product_read_write_role" {
  providers               = { snowflake = snowflake.hm_production_terraform_read_write_role }
  source                  = "../../../modules/snowflake/hm_snowflake_grant_schema_privileges_to_role"
  snowflake_role_name     = module.snowflake_production_hm_kafka_db_product_read_write_role.name
  privileges              = ["USAGE", "CREATE TABLE", "CREATE STAGE", "CREATE PIPE"]
  snowflake_database_name = module.snowflake_production_hm_kafka_db_database.name
  snowflake_schema_name   = module.snowflake_production_hm_kafka_db_product_schema.name
  depends_on = [
    module.snowflake_production_hm_kafka_db_product_read_write_role,
    module.snowflake_production_hm_kafka_db_database,
    module.snowflake_production_hm_kafka_db_product_schema
...
module "snowflake_grant_warehouse_privileges_to_production_hm_kafka_db_product_read_write_role" {
  providers                = { snowflake = snowflake.hm_production_terraform_read_write_role }
  source                   = "../../../modules/snowflake/hm_snowflake_grant_warehouse_privileges_to_role"
  snowflake_role_name      = module.snowflake_production_hm_kafka_db_product_read_write_role.name
  privileges               = ["USAGE"]
