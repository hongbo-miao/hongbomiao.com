...
module "airbyte_destination_snowflake_production_hm_airbyte_db_database_engineering_world_schema" {
  source                                = "../../../modules/airbyte/hm_airbyte_destination_snowflake"
...
# - Source - CSV: cities
# - Destination - Snowflake | Database: PRODUCTION_HM_AIRBYTE_DB | Schema: ENGINEERING_WORLD
module "hm_airbyte_connection_csv_cities_to_snowflake_production_hm_airbyte_db_database_engineering_world_schema" {
  source         = "../../../modules/airbyte/hm_airbyte_connection"
  name           = "${module.airbyte_source_csv_cities.name}-to-${module.airbyte_destination_snowflake_production_hm_airbyte_db_database_engineering_world_schema.name}"
  source_id      = module.airbyte_source_csv_cities.id
  destination_id = module.airbyte_destination_snowflake_production_hm_airbyte_db_database_engineering_world_schema.id
  streams = [
    {
      name      = "cities"
