    ...
    [
      ...
      },
      {
        ...
        "Properties": {
          ...
          "exchange.base-directories": "s3://${module.production_amazon_hm_production_s3_bucket.name}/amazon-emr/clusters/${local.amazon_emr_cluster_name}/exchange-spooling",
