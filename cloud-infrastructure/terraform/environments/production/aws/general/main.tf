...
module "production_hm_amazon_msk_tracker_sink_plugin" {
  ...
  s3_bucket_arn            = data.terraform_remote_state.hm_terraform_remote_state_production_aws_data.outputs.production_hm_production_bucket_amazon_s3_bucket_arn
...
module "production_hm_amazon_msk_tracker_sink_connector_iam" {
  ...
  msk_plugin_s3_bucket_name = data.terraform_remote_state.hm_terraform_remote_state_production_aws_data.outputs.production_hm_production_bucket_amazon_s3_bucket_name
  msk_log_s3_bucket_name    = data.terraform_remote_state.hm_terraform_remote_state_production_aws_data.outputs.production_hm_production_bucket_amazon_s3_bucket_name
  environment               = var.environment
  team                      = var.team
}
