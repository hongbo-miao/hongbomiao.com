    ...
    [
      ...
      },
      {
        ...
        "Properties": {
          ...
          "exchange.base-directories": "s3://${data.terraform_remote_state.hm_terraform_remote_state_production_aws_network.outputs.production_hm_production_bucket_amazon_s3_bucket_name}/amazon-emr/clusters/${local.amazon_emr_cluster_name}/exchange-spooling",
...
module "production_hm_glue_databrew_recipe_job_write_adsb_2x_flight_trace_csv_to_parquet_iam" {
  ...
  input_s3_bucket_name           = data.terraform_remote_state.hm_terraform_remote_state_production_aws_network.outputs.production_hm_production_bucket_amazon_s3_bucket_name
  output_s3_bucket_name          = data.terraform_remote_state.hm_terraform_remote_state_production_aws_network.outputs.production_hm_production_bucket_amazon_s3_bucket_name
  environment                    = var.environment
  team                           = var.team
}
...
module "production_hm_amazon_msk_tracker_sink_plugin" {
  ...
  s3_bucket_arn            = module.production_hm_production_bucket_amazon_s3_bucket_name.arn
...
module "production_hm_amazon_msk_tracker_sink_connector_iam" {
  ...
  msk_plugin_s3_bucket_name = data.terraform_remote_state.hm_terraform_remote_state_production_aws_network.outputs.production_hm_production_bucket_amazon_s3_bucket_name
  msk_log_s3_bucket_name    = data.terraform_remote_state.hm_terraform_remote_state_production_aws_network.outputs.production_hm_production_bucket_amazon_s3_bucket_name
  environment               = var.environment
  team                      = var.team
}
...
# AWS Batch
module "production_hm_aws_batch_security_group" {
  providers                      = { aws = aws.production }
...
module "production_hm_aws_batch_compute_environment_iam" {
  providers                              = { aws = aws.production }
...
module "production_hm_aws_batch_compute_environment" {
  providers                          = { aws = aws.production }
  source                             = "../../../../modules/aws/hm_aws_batch_compute_environment"
  aws_batch_compute_environment_name = "hm-aws-batch-compute-environment"
  amazon_ec2_security_group_ids      = [module.production_hm_aws_batch_security_group.id]
  amazon_vpc_subnet_ids              = data.terraform_remote_state.hm_terraform_remote_state_production_aws_network.outputs.production_hm_production_bucket_amazon_s3_bucket_name
  iam_role_arn                       = module.production_hm_aws_batch_compute_environment_iam.arn
  environment                        = var.environment
  team                               = var.team
  depends_on = [
    module.production_hm_aws_batch_compute_environment_iam
...
module "production_hm_aws_batch_job_queue" {
  providers                          = { aws = aws.production }
  source                             = "../../../../modules/aws/hm_aws_batch_job_queue"
  aws_batch_job_queue_name           = "hm-aws-batch-queue"
  aws_batch_compute_environment_arns = [module.production_hm_aws_batch_compute_environment.arn]
  environment                        = var.environment
  team                               = var.team
}
...
module "production_hm_aws_batch_job_definition" {
  providers                     = { aws = aws.production }
  source                        = "../../../../modules/aws/hm_aws_batch_job_definition"
  aws_batch_job_definition_name = "hm-aws-batch-definition"
  iam_role_arn                  = module.production_hm_aws_batch_job_definition_iam.arn
  environment                   = var.environment
  team                          = var.team
  depends_on = [
    module.production_hm_aws_batch_job_definition_iam
