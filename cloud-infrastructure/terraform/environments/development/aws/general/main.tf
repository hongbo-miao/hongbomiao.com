    ...
    [
      ...
      },
      {
        ...
        "Properties": {
          ...
          "exchange.base-directories": "s3://${data.terraform_remote_state.hm_terraform_remote_state_development_aws_data.outputs.development_hm_development_bucket_amazon_s3_bucket_name}/amazon-emr/clusters/${local.amazon_emr_cluster_name}/exchange-spooling",
...
module "development_hm_sedona_s3_set_up_script" {
  providers       = { aws = aws.development }
  source          = "../../../../modules/aws/hm_amazon_s3_object"
  s3_bucket_name  = data.terraform_remote_state.hm_terraform_remote_state_development_aws_data.outputs.development_hm_development_bucket_amazon_s3_bucket_name
...
module "development_hm_glue_databrew_recipe_job_write_adsb_2x_flight_trace_csv_to_parquet_iam" {
  ...
  input_s3_bucket_name           = data.terraform_remote_state.hm_terraform_remote_state_development_aws_data.outputs.development_hm_development_bucket_amazon_s3_bucket_name
  output_s3_bucket_name          = data.terraform_remote_state.hm_terraform_remote_state_development_aws_data.outputs.development_hm_development_bucket_amazon_s3_bucket_name
  environment                    = var.environment
  team                           = var.team
}
...
module "development_hm_amazon_msk_tracker_sink_plugin" {
  ...
  s3_bucket_arn            = data.terraform_remote_state.hm_terraform_remote_state_development_aws_data.outputs.development_hm_development_bucket_amazon_s3_bucket_arn
...
module "development_hm_amazon_msk_tracker_sink_connector_iam" {
  ...
  msk_plugin_s3_bucket_name = data.terraform_remote_state.hm_terraform_remote_state_development_aws_data.outputs.development_hm_development_bucket_amazon_s3_bucket_name
  msk_log_s3_bucket_name    = data.terraform_remote_state.hm_terraform_remote_state_development_aws_data.outputs.development_hm_development_bucket_amazon_s3_bucket_name
  environment               = var.environment
  team                      = var.team
}
...
module "development_hm_aws_batch_compute_environment" {
  ...
  amazon_vpc_subnet_ids              = data.terraform_remote_state.hm_terraform_remote_state_development_aws_data.outputs.development_hm_development_bucket_amazon_s3_bucket_name
