...
module "snowflake_flight_software_schema" {
  providers               = { snowflake = snowflake.sysadmin }
...
module "snowflake_grant_privileges_to_account_role_database_grant" {
  providers               = { snowflake = snowflake.securityadmin }
  source                  = "./modules/snowflake/hm_snowflake_grant_privileges_to_account_role_database_grant"
...
module "snowflake_grant_privileges_to_account_role_schema_grant" {
  providers               = { snowflake = snowflake.securityadmin }
  source                  = "./modules/snowflake/hm_snowflake_grant_privileges_to_account_role_schema_grant"
  account_role_name       = module.snowflake_streamlit_role.name
  privileges              = ["USAGE", "CREATE STREAMLIT", "CREATE STAGE"]
  snowflake_database_name = module.snowflake_streamlit_db_database.name
  snowflake_schema_name   = module.snowflake_flight_software_schema.name
  depends_on = [
    module.snowflake_streamlit_role,
    module.snowflake_streamlit_db_database,
    module.snowflake_flight_software_schema
...
module "horizon_snowflake_grant_privileges_to_account_role_warehouse_grant" {
  providers                = { snowflake = snowflake.securityadmin }
  source                   = "./modules/snowflake/hm_snowflake_grant_privileges_to_account_role_warehouse_grant"
  account_role_name        = module.snowflake_streamlit_role.name
  privileges               = ["USAGE"]
