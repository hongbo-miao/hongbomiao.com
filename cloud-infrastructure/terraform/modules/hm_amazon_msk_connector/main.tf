...
resource "aws_mskconnect_connector" "hm_amazon_msk_connector" {
  ...
  connector_configuration = {
    ...
    "snowflake.topic2table.map" : "tracker-hongbo-test.analytic-events:analytic_events_hongbo_test",
    "snowflake.topic2table.map" : "tracker.analytic-events.avro:analytic-events",
