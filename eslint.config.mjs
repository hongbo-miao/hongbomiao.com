...
export default [
  {
    ...
    ignores: [
      ...
      'fine-tuning/fine-tune-whisper/output',
      'fine-tuning/hm-axolotl/last_run_prepared',
      'fine-tuning/hm-llama-factory/data',
      'fine-tuning/hm-llama-factory/saves',
      'fine-tuning/hm-unsloth/output',
      'fine-tuning/hm-unsloth/unsloth_compiled_cache',
      'fine-tuning/hm-unsloth/unsloth_training_checkpoints',
