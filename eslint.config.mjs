...
export default [
  {
    ...
    ignores: [
      ...
      'api-python/dist/**/*',
      'api-rust/models/**/*',
      'audio/automatic-speech-recognition/hm-faster-whisper/data/**/*',
      'audio/automatic-speech-recognition/hm-faster-whisper/output/**/*',
      'audio/automatic-speech-recognition/hm-speaches/data/**/*',
      'caddy/public/**/*',
      ...
      'data-visualization/hm-plotly/*/output/**/*',
      ...
      'infrastructure/opentofu/environments/production/aws/data/files/amazon-msk/*/plugins/*.zip',
