...
export default [
  {
    ...
    ignores: [
      ...
      'data-visualization/grafana/hm-panel-plugin/test-results/**/*',
      'data-visualization/grafana/hm-panel-plugin/playwright-report/**/*',
      'data-visualization/grafana/hm-panel-plugin/playwright/**/*',
      ...
      'infrastructure/ansible/secrets/**/*',
      ...
      'large-language-model-inference/llama-cpp/models/**/*',
      'large-language-model-post-training/fine-tuning/hm-axolotl/last_run_prepared/**/*',
      'large-language-model-post-training/fine-tuning/hm-llama-factory/saves/**/*',
      'large-language-model-post-training/fine-tuning/hm-unsloth/unsloth_compiled_cache/**/*',
      'large-language-model-post-training/fine-tuning/hm-unsloth/unsloth_training_checkpoints/**/*',
      ...
      'mobile/mobile-ios/mobile-ios/Resources/Models/**/*',
