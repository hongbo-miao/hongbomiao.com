module github.com/hongbo-miao/hongbomiao.com/api/api-go
...
require (
	...
	go.elastic.co/apm/module/apmgin/v2 v2.7.5
	go.elastic.co/apm/module/apmgrpc/v2 v2.7.5
...
require (
	...
	go.elastic.co/apm/module/apmhttp/v2 v2.7.5 // indirect
	go.elastic.co/apm/v2 v2.7.5 // indirect
